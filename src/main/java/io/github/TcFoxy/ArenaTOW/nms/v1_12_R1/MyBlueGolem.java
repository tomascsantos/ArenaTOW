...
//					Bukkit.broadcastMessage("damage entity cancelled the damage, the team was: " + arenateam);
//					Bukkit.broadcastMessage("equals returned: " + arenateam.equals(Utils.toSimpleColor(Color.BLUE)));
//					return false;
