...
public class MyArenaClass {
	public static final Integer DEFAULT = Integer.MAX_VALUE;
	public static final MyArenaClass CHOSEN_CLASS = new MyArenaClass("CHOSENCLASS","chosenClass", null, null, null);
	public static final MyArenaClass SELF_CLASS = new MyArenaClass("SELFCLASS","selfClass", null, null, null);
    ...
    public MyArenaClass(String name){
		this(name,name,new ArrayList<ItemStack>(),new ArrayList<PotionEffect>(),new ArrayList<String>());
		valid = false;
	}

	public MyArenaClass(String name, String displayName, List<ItemStack> items, List<PotionEffect> effects, List<String> perms){
		this.name = name;
