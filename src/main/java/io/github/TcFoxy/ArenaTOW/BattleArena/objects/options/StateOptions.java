...
import static mc.alk.arena.objects.options.TransitionOption.ALWAYSWOOLTEAMS;
import static mc.alk.arena.objects.options.TransitionOption.BLOCKBREAKOFF;
import static mc.alk.arena.objects.options.TransitionOption.BLOCKPLACEOFF;
import static mc.alk.arena.objects.options.TransitionOption.CLEARINVENTORY;
import static mc.alk.arena.objects.options.TransitionOption.DEENCHANT;
...
import static mc.alk.arena.objects.options.TransitionOption.RESPAWN;
...
import static mc.alk.arena.objects.options.TransitionOption.TELEPORTIN;
import static mc.alk.arena.objects.options.TransitionOption.TELEPORTLOBBY;
import static mc.alk.arena.objects.options.TransitionOption.TELEPORTMAINLOBBY;
import static mc.alk.arena.objects.options.TransitionOption.TELEPORTMAINWAITROOM;
import static mc.alk.arena.objects.options.TransitionOption.TELEPORTOUT;
import static mc.alk.arena.objects.options.TransitionOption.TELEPORTSPECTATE;
import static mc.alk.arena.objects.options.TransitionOption.TELEPORTTO;
import static mc.alk.arena.objects.options.TransitionOption.TELEPORTWAITROOM;
import static mc.alk.arena.objects.options.TransitionOption.UNDISGUISE;
import static mc.alk.arena.objects.options.TransitionOption.WGCLEARREGION;
import static mc.alk.arena.objects.options.TransitionOption.WITHINDISTANCE;
import static mc.alk.arena.objects.options.TransitionOption.WOOLTEAMS;
import static mc.alk.arena.objects.options.TransitionOption.valueOf;
