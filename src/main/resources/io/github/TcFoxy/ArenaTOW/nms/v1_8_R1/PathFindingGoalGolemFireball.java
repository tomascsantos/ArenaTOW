...
class PathfinderGoalGolemFireball extends PathfinderGoal
{
	...
	{
		EntityLiving localEntityLiving = this.a.getGoalTarget();
		if((this.a.getClass().getName() == "io.github.TcFoxy.ArenaTOW.nms.v1_8_R1.CustomBlueGolem" &&
				localEntityLiving.getClass().getName() == "io.github.TcFoxy.ArenaTOW.nms.v1_8_R1.EntityBlueZombie") ||
				(this.a.getClass().getName() == "io.github.TcFoxy.ArenaTOW.nms.v1_8_R1.CustomRedGolem" &&
						localEntityLiving.getClass().getName() == "io.github.TcFoxy.ArenaTOW.nms.v1_8_R1.EntityRedZombie")){
			return;
		}
		this.c -= 1;
