...
class v1_12_R1_MobHandler implements TOWEntityHandler {
    ...
    public TOWEntity getTowEntity(Object o) {
        ...
        if (o instanceof Entity) {
            return towEntities.get(((Entity) o).getUniqueId());
        }
        return null;
    }
    ...
    static void clearBehavior(PathfinderGoalSelector goalSelector, PathfinderGoalSelector targetSelector) {
        LinkedHashSet goalB = (LinkedHashSet) v1_12_R1_MobHandler.getPrivateField("b", PathfinderGoalSelector.class, goalSelector);
        goalB.clear();
        LinkedHashSet goalC = (LinkedHashSet) v1_12_R1_MobHandler.getPrivateField("c", PathfinderGoalSelector.class, goalSelector);
        goalC.clear();
        LinkedHashSet targetB = (LinkedHashSet) v1_12_R1_MobHandler.getPrivateField("b", PathfinderGoalSelector.class, targetSelector);
        targetB.clear();
        LinkedHashSet targetC = (LinkedHashSet) v1_12_R1_MobHandler.getPrivateField("c", PathfinderGoalSelector.class, targetSelector);
        targetC.clear();
    }
