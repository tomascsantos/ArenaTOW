...
public class v1_12_R1_Listener implements Listener {

    File dir;
    v1_12_R1_EntityRegistrar registrar;

    public v1_12_R1_Listener(v1_12_R1_EntityRegistrar registrar, File dir) {
    ...
    public void onChunkUnload(final ChunkUnloadEvent evt) {
        ...
        for (org.bukkit.entity.Entity e : c.getEntities()) {
            ...
            if (nmsEntity instanceof EntityInsentient) if (registrar.registryEntries.containsKey(EntityTypes.b(nmsEntity))) registrar.saveEntity((EntityInsentient) nmsEntity);
        }
    }
}
