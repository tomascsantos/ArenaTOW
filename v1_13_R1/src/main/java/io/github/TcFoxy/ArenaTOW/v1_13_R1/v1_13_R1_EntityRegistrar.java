...
public class v1_13_R1_EntityRegistrar implements CustomEntityRegistrar{

    public final Map<String, v1_13_R1_Entities> registryEntries = new HashMap<String, v1_13_R1_Entities>();
    File dir;

    v1_13_R1_EntityRegistrar(File dir) {
        this.dir = dir;
    }

    public void registerEntities() {
        for (v1_13_R1_Entities entity : v1_13_R1_Entities.values()) {
            register(entity);
        }
    }
    ...
    public void unregisterEntities() {
        ...
        for (v1_13_R1_Entities cre : registryEntries.values()) unregister(cre);
    ...
    public void register(final v1_13_R1_Entities cre) {
     ...
     * <b>Will not work if you create a new instance of v1_13_R1_Entities, even if it has the same parameters.</b><br><br>
     *
     ...
     */
    @SuppressWarnings("unchecked")
    public void unregister(final v1_13_R1_Entities cre) {
    ...
    protected boolean loadEntity(NBTTagCompound nbt, World w) {
        ...
        try {
            ...
            final net.minecraft.server.v1_13_R1.World nmsW = ((CraftWorld)w).getHandle();
            EntityInsentient e = clazz.getConstructor(net.minecraft.server.v1_13_R1.World.class).newInstance(nmsW);
