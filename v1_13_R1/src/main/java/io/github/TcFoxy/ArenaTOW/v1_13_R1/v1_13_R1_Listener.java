...
public class v1_13_R1_Listener implements Listener {

    File dir;
    v1_13_R1_EntityRegistrar registrar;

    public v1_13_R1_Listener(v1_13_R1_EntityRegistrar registrar, File dir) {
    ...
    public void onChunkUnload(final ChunkUnloadEvent evt) {
        ...
        for (org.bukkit.entity.Entity e : c.getEntities()) {
            ...
            if (nmsEntity instanceof EntityInsentient) if (registrar.registryEntries.containsKey(EntityTypes.getName(nmsEntity))) registrar.saveEntity((EntityInsentient) nmsEntity);
        }
    }
}
